...
@router.get("/produtos/", response_model=List[schemas.ProductGet], description="Faz a leitura de todos os produtos armazenados no banco")
...
=======
@router.post("/produtos", response_model=schemas.ProductBase, description="Faz a criação de um novo produto")
>>>>>>> 271118bd678c81978688f6c15a3e32ad4dd9f539
...
<<<<<<< HEAD
@router.delete("/produtos/{produto_id}", response_model=schemas.ProductGet, description="Faz a deleção de um produto")
=======
...
<<<<<<< HEAD
@router.put("/produtos/{produto_id}",response_model=schemas.ProductGet, description="Faz a atualização de um produto")
=======
